...
const Transaction = () => {
    ...
    return (
        <div className="h-lvh  px-2">
            <div className="bg-[rgba(55,65,81,1)] p-4 rounded-lg shadow w-[110%] sm:w-full max-w-4xl mx-auto mt-2 mb-5 pt-10 sm:min-w-96" style={{height:'95%'}} >
            ...
            {/* p-4 */}
                ...
                <div className="w-full px-1"><DataTableComponent/></div>
            </div>
        </div>
        </div>
    );
